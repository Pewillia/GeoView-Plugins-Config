        ...
        <div className="InputForm">
            ...
            <Formik
                ...
                onSubmit={(values, formikHelpers) =>
                {
                       ...
                       {
                           navigate("/plugin",{state:{data:response.data,desiredPlugin:values.plugin}})
                ...
                {({ values, setFieldValue ,errors, isValid, touched, dirty }) => (
                    <Form >
                        ...
                        <FormControl component="fieldset">
                            ...
                            <RadioGroup   row aria-label="language" name="row-radio-buttons-group" value={values.initialValues} onChange={(event) => {
                        ...
                        <FormControl component="fieldset">
                            ...
                            <RadioGroup   row aria-label="plugin" name="row-radio-buttons-group"  value={values.initialValues} onChange={(event) => {setFieldValue("plugin", event.currentTarget.value)}}>
                                <Box height={16}/>
                                <FormControlLabel value="Range Slider" control={<Radio />} label="Range Slider" />
                                <FormControlLabel value="Chart" control={<Radio />} label="Chart" />
                                <FormControlLabel value="Swiper" control={<Radio />} label="Swiper" />
                                <FormControlLabel value="Draw Toolbar" control={<Radio />} label="Draw Toolbar" />
                                <FormControlLabel value="Thematic Chart" control={<Radio />} label="Thematic Chart" />
                            </RadioGroup>
                        </FormControl>
                        <Box height={14}/>
                        <Button
